...
from Server.filter_dialogs.utils import get_data_statistics, add_padding_to_tokenizer, GetData
...
def warmup_train():
    ...
    train_dataset = data_getter.get_dataset(data_args.train_files,
                                         tokenizer=tokenizer,
                                         max_seq_length=data_args.max_seq_length,
                                         sample_percentage=data_args.train_percentage,
    ...
    if training_args.analysis_mode:
        # analysis_dataset = get_valid_dataset(training_args.analysis_dataset,
        #                                data_dir=data_args.data_dir,
        #                                tokenizer=tokenizer,
        #                                max_length=data_args.max_seq_length)
        analysis_dataset = data_getter.get_dataset(data_args.train_files,
                                         tokenizer=tokenizer,
                                         max_seq_length=data_args.max_seq_length,
                                         sample_percentage=data_args.valid_percentage,
                                         seed=data_args.sample_data_seed)
